...
<body>
  ...
  <header class="header bg-blue">
    <nav class="navbar bg-blue">
      <div class="container flex">
        ...
        <a href="guest.php" class="navbar-brand"></a>
  ...
  <main>
        ...
        <div class="header-inner text-white text-center"style="background-color: #1c60e8; color: white;">
      <div class="container grid">
        <div class="header-inner-left">
          ...
          <div class="btn-group">
            <a href="#contact" class="btn btn-light-blue">Scroll down & Explore</a>
          </div>
        </div>
    ...
    <script>
      $(document).ready(function(){
        $("nav .nav-link").click(function(e){
          ...
          // Optional: Load the page content dynamically if needed
          let href = $(this).attr("href");
          // If it's an internal anchor, do nothing
          if(href.startsWith("#"))return;
          // Otherwise, load it into a #content container (if you're using one)
          $("#content").load(href);
        });
      })
    </script>
